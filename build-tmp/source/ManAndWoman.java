...
public class ManAndWoman extends PApplet {
...
int[][] colors = new int[MAX_LEVEL][5];
...
public void incrementLevel()
{
	...
	if(level == MAX_LEVEL)
	{
		println("MAX LEVEL REACHED (Max level is " + level + ")");
		System.exit(0);
	}
	state = PLAYING;
	updateLevel();
...
public void drawLauncher()
{
	...
	man.box.setFillColor(colors[0][4]);
	...
	ptemp.box.setFillColor(colors[0][1]);
...
public void drawLevel()
{
	...
	man.box.setFillColor(colors[0][4]);
	wman.box.setFillColor(colors[0][3]);
...
class Man extends GameObject
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ManAndWoman" };
    if (passedArgs != null) {
